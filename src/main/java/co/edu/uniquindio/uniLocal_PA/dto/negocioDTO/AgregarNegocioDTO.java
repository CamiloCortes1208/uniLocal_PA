...
public record AgregarNegocioDTO(
        @NotBlank(message = "Es necesario el id del cliente") String codigoCliente,
        @NotBlank @Size(min = 10, max = 50, message = "El nombre de negocio debe tener minimo 10 letras y maximo 50") String nombreNegocio,
        @NotBlank @Size(max = 300, message = "La descripción de negocio debe tener minimo 10 letras y maximo 50") String descripcion,
        ...
        @NotEmpty(message = "La lista de teléfonos no puede estar vacía") @Size(min = 1, max = 5, message = "La lista de teléfonos debe tener entre 1 y 5 elementos") List<String> listaTelefonos,
